...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.list[].timeoutSeconds": "Agent Timeout (sec)",
  agents: "Agents",
  ...
  "messages.groupChat.recentContextLimit": "Group Recent Context Limit",
  "messages.groupChat.recentContextMaxAgeHours": "Group Recent Context Max Age",
